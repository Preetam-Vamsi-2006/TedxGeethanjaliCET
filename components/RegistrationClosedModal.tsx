          ...
          >
            <div className="bg-gradient-to-br from-black to-black/80 border border-ted/50 rounded-xl shadow-2xl overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-ted/20 to-ted/10 border-b border-ted/30 px-6 py-4 flex justify-between items-center">
                <h2 className="text-2xl font-bold text-ted">Register Now</h2>
                <motion.button
                ...
                >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 bg-ted/20 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-ted/30">
                        <svg
                      ...
                      <div className="text-left">
                        <h3 className="text-white font-semibold text-base">Individual Pass</h3>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-white font-semibold text-base">Group Pass</h3>
                        <p className="text-white/60 text-sm mt-1">
              ...
              {/* Footer */}
              <div className="bg-black/40 border-t border-ted/20 px-6 py-3 flex justify-center">
                <motion.button
